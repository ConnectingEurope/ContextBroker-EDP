...
- Integration Solution core component [`cb_edp/`](cb_edp/): Command
  line interface (CLI) application that offers the options needed to
  work with the integration.
- Integration Solution API [`cb_edp/api`](cb_edp/api/): The scope of
...
```
sudo pip3 install /path/to/cb_edp.zip
```
